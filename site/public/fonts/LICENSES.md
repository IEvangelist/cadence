...
All font files in this directory are licensed under the **SIL Open Font License,
Version 1.1** (OFL-1.1), which permits bundling, redistribution, and self-hosting
(including for commercial use). The reserved font names are unchanged and no font
is sold on its own.

| Family | File | Copyright | Source |
| --- | --- | --- | --- |
| Bricolage Grotesque | `bricolage-grotesque-var-latin.woff2` | Copyright © 2022 The Bricolage Grotesque Project Authors | https://github.com/ateliertriay/bricolage |
| Inter | `inter-var-latin.woff2` | Copyright © 2016 The Inter Project Authors | https://github.com/rsms/inter |
| Fraunces | `fraunces-var-latin.woff2` | Copyright © 2019 The Fraunces Project Authors | https://github.com/undercasetype/Fraunces |
| Manrope | `manrope-var-latin.woff2` | Copyright © 2018 The Manrope Project Authors | https://github.com/sharanda/manrope |
| Sora | `sora-var-latin.woff2` | Copyright © 2020 The Sora Project Authors | https://github.com/soratype/sora |

Each file is the **latin-subset variable** build fetched from Google Fonts
(`fonts.gstatic.com`), which distributes these families under OFL-1.1.

## SIL Open Font License, Version 1.1

    Copyright of each family is held by its respective authors listed above.

...
export const interactionManifest: readonly InteractionManifestEntry[] = [
  ...
  mobile(
    ...
    'studio',
    'button',
    '/Create|Open|Import|Save|Share|Export/',
    'Runs the selected project command while preventing duplicate work.',
    'repeated',
  ),
  mobile(
    'mobile.ai.generate',
    'studio',
    'button',
    '/Generate idea|Generating idea/',
    'Requests a Basic AI idea and exposes its busy state.',
  ),
  mobile(
    'mobile.ai.accept',
    'studio',
    'button',
    'Accept',
    'Commits the pending Basic AI suggestion to the project.',
  ),
  mobile(
    'mobile.ai.discard',
    'studio',
    'button',
    'Discard',
    'Discards the pending Basic AI suggestion without changing notes.',
  ),
